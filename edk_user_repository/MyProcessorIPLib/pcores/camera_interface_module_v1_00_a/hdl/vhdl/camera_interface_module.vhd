------------------------------------------------------------------------------
-- camera_interface_module.vhd - entity/architecture pair
------------------------------------------------------------------------------
-- IMPORTANT:
...
--
------------------------------------------------------------------------------
-- Filename:          camera_interface_module.vhd
-- Version:           1.00.a
...
use camera_interface_module_v1_00_a.user_logic;
...
entity camera_interface_module is
  generic
  (
  ...
  (
    ...
    --USER ports added here
	 -- use input ports when changing to teachers board
...
end entity camera_interface_module;

------------------------------------------------------------------------------
-- Architecture section
------------------------------------------------------------------------------

architecture IMP of camera_interface_module is
  ...
  ------------------------------------------
  -- user signal
  -- remove them when using the teachers board
...
begin
  ...
  ------------------------------------------
  USER_LOGIC_I : entity camera_interface_module_v1_00_a.user_logic
    generic map
    (
  ...
  IMAGE_GENERATOR_I: ImageGenerator 
	 generic map
	 (
	         width => 640,
				height=> 480
