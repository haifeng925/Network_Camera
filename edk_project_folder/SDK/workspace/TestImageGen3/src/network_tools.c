...
int EmacLiteSendFrame(u32 PayloadSize)
{
	...
	mac_ip_udp_header->src_port_h = UDP_PORT/256; // Source Port: match your PC code
	mac_ip_udp_header->src_port_l = UDP_PORT%256;

	mac_ip_udp_header->dst_port_h = UDP_PORT/256; // Destination Port: match your PC code
	mac_ip_udp_header->dst_port_l = UDP_PORT%256; // Destination Port: match your PC code
	///////////////////////////////////////////////////////////////////////
